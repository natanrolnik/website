		...
		{#each socialLinks as link}
			...
			>
				...
				{:else if link.icon === 'youtube'}
					<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
						<path d="M23.498 6.186a2.99 2.99 0 00-2.106-2.115C19.512 3.5 12 3.5 12 3.5s-7.512 0-9.392.571A2.99 2.99 0 00.502 6.186 31.84 31.84 0 000 12a31.84 31.84 0 00.502 5.814 2.99 2.99 0 002.106 2.115C4.488 20.5 12 20.5 12 20.5s7.512 0 9.392-.571a2.99 2.99 0 002.106-2.115A31.84 31.84 0 0024 12a31.84 31.84 0 00-.502-5.814zM9.6 15.568V8.432L15.86 12 9.6 15.568z"/>
					</svg>
				{/if}
			</a>
		{/each}
...
<style>
	...
	.social-links a.icon-email:hover {
		color: #9edbff;
	}
